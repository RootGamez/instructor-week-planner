import { closeModal, openModal, showGlobalMessage } from "../ui/dom.js";
import {
  handleAdminLogin,
  handleAdminLogout,
  ...
  syncAdminUi
} from "../features/auth/authFeature.js";
import {
  handleDeleteContent,
  handleEditContent,
  ...
  loadBootstrap,
  renderTable
} from "../features/schedule/scheduleFeature.js";
import { connectWebSocket, configureRealtime, releaseCurrentEditingLock } from "../services/realtimeService.js";
import {
  handleCurrentWeek,
  handleNextWeek,
  handlePreviousWeek,
  ...
  initWeekPicker
} from "../features/week/weekFeature.js";
import { handleLockClick, handleNewWeekClick } from "../features/admin/adminFeature.js";
import { openCatalogManager, wireCatalogManager } from "../features/catalog/catalogFeature.js";
